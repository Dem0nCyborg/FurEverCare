...
import com.chandan.furever_care.databinding.SingleVideoRowBinding
...
class ReelsAdapter(
    ...
    class VideoViewHolder(
        val binding: SingleVideoRowBinding,
        var context: Context,
        var videoPreparedListener: OnVideoPreparedListener
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoViewHolder {
        val view = SingleVideoRowBinding.inflate(LayoutInflater.from(context), parent, false)
